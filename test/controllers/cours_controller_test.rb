...
class CoursControllerTest < ActionController::TestCase
  ...
  test "should create cour" do
    assert_difference('Cour.count') do
      post :create, cour: { description: @cour.description, institution: @cour.institution, langue: @cour.langue, nom: @cour.nom, professeur: @cour.professeur, theme: @cour.theme }
    end
  ...
  test "should update cour" do
    patch :update, id: @cour, cour: { description: @cour.description, institution: @cour.institution, langue: @cour.langue, nom: @cour.nom, professeur: @cour.professeur, theme: @cour.theme }
    assert_redirected_to cour_path(assigns(:cour))
  end
